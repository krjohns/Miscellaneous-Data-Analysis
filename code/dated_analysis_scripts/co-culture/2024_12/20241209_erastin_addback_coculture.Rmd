---
title: "Erastin Add-Back Co-culture"
author: "Kate Johnson"
date: "2024-12-09"
...
output_dir = fs::path(wd, "../../../../output/2024/2024_12/20241209/20241209_coculture")
```

# load data ----
```{r}
dat = read_xlsx(path(input_dir, "2024/2024_12/20241209_coculture/20241209_erastin_addback_coculture.xlsx")) 
```
...
p<-ggplot(plot_me, 
  ...
  geom_errorbar(data= means,
                ...
                inherit.aes=F) +
  geom_hline(data = subset(means, Treatment == "OVA"),
             aes(yintercept = 34.6), linetype = 2) +
  geom_hline(data = subset(means, Treatment == "LSG"),
             aes(yintercept = 89.63), linetype = 2) +
...
p
save_plot(path(output_dir, "erastin_addback/Erastin_addback_Percent_Proliferated.pdf"), p,
          base_aspect_ratio = 2.75)
...
p<-ggplot(plot_me, 
  ...
  theme(axis.text.x =element_text(angle =45,hjust =1),
        ...
        legend.position = "none")
p
save_plot(path(output_dir, "erastin_addback/Erastin_addback_Tcell_Percent_Live.pdf"), p,
          base_aspect_ratio = 2.75)
