...
output_dir = fs::path(wd, "../../output/2024/2024_06/20240620/sno_scrn_LPS100")
```

# load data ----
```{r}
ids = read.csv(path(input_dir, "2024/2024_06/sno_scrn/sno_target_ids.csv")) 
dat = read.csv(path(input_dir, "2024/2024_06/sno_scrn/20240620_sno_scrn_full_LPS100.csv")) 
...
save_plot(path(output_dir, "legend.pdf"), p, 
