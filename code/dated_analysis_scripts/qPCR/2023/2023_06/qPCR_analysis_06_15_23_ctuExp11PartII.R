...
output_dir = path(wd, "output/2023/2023_06/2023_06_15")

#read in data
qPCR_dat = read.csv(fs::path(input_dir, "2023_06_15_Exp11_Elp3Trmt6Trmt61aKD_formatted.csv")) %>%
           data.frame() %>%
...
write.csv(as.matrix(dCq_dat), path(wd, "output/2023/2023_06/2023_06_02/2023_06_15_ctuExp11_PARTII.csv"))
...
dat = dCq_dat %>% 
           ...
           Target_oligo = factor(Target_oligo, levels = c("Empty_sh11",
                                        ...
                                        str_c("Trmt61a_sh", c(26:28)))))

p1<-make_Cq_plot_bar("Trmt61a", dat) + 
     scale_fill_manual(values =c( Scr = "grey",
                                  Empty = "grey90",
                                  Elp3 = "#F8766D",
                                  Trmt6 = "#CD9600",
                                  Trmt61a = "#00A9FF")) +
     labs(title = "Trmt61a Expression") 
...
p3 <- make_Cq_plot_bar("Trmt61a", dat, dCq = T) + 
      scale_fill_manual(values =c( Scr = "grey",
                                   Empty = "grey90",
                                   Elp3 = "#F8766D",
                                   Trmt6 = "#CD9600",
                                   Trmt61a = "#00A9FF")) +
      labs(title = "Delta Cq (Trmt61a - Gapdh)") 

save_plot(path(output_dir, "Trmt61a_KD/Trmt61a_cq.pdf"), p1)
save_plot(path(output_dir, "Trmt61a_KD/Gapdh_cq-Trmt61aKD.pdf"), p2)
save_plot(path(output_dir, "Trmt61a_KD/Trmt61a-Gapdh_dcq.pdf"), p3)
