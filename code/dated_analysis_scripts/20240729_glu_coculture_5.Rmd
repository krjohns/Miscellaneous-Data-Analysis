...
means = plot_me2 %>% ungroup() %>% select(Name, Treatment, avg_prolif, avg_live) %>% unique()
...
p
save_plot(path(output_dir, "Combos_Exp_live_AAA_DAP5.pdf"), p,
          base_aspect_ratio = 1)
