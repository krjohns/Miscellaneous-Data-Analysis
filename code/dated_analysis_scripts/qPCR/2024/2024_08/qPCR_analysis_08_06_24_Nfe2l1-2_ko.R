...
#read in data
qPCR_dat = read.csv(fs::path(input_dir, "20240806_Nfe2l1-2ko_qPCR.csv")) %>%
           data.frame() %>%
...
write.csv(as.matrix(dCq_dat), path(wd, "output/2024/2024_08/20240806/202400806_Nfe2l1-2ko_qPCR_dat.csv"))
...
plot_me <- dCq_dat %>%
           ...
           unique() %>%
           mutate(Gene = factor(Gene, levels = c("Nfe2l1", "Nfe2l2", "Gclc")),
...
save_plot(path(wd, "output/2024/2024_08/20240806/20240806_Nfe2l1.pdf"), p,
