...
output_dir = path(wd, "output/2023/2023_05/2023_05_30")

#read in data
qPCR_dat = read.csv(fs::path(input_dir, "2023-05-30-CtuExp10-sideExp_formatted.csv")) %>%
           data.frame() %>%
...
write.csv(as.matrix(dCq_dat), path(output_dir, "2023_05_30_ctuExp10_sideExp_dCqTable.csv"))
